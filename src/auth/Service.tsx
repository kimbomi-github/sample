...
const Service = () => {
  ...
  return (
    <div className={cx('rules')}>
        ...
        <p>
        [무아 온라인 회원 약관]<br />
        이 약관은 무아(이하 '본원')에서 제공하는 서비스 이용조건 및 절차에 관한 사항과 기타 필요한 사항을 전기통신사업법 및 동법 시행령이 정하는 대로 준수하고 규정함을 목적으로 합니다.
        </p>

        <h3>제1조(목적 등)</h3>
        <p>
        ① 본원 (https://www.mooaa.co.kr) 이용자 약관(이하 "본 약관"이라 합니다)은 이용자가 본원에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 합니다)를 이용함에 있어 회원과 본원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
        </p>
        <p>
        ② 회원이 되고자 하는 자가 본원에서 정한 소정의 절차를 거쳐서 "등록하기" 단추를 누르면 본 약관에 동의하는 것으로 간주합니다.<br />
        본 약관에 정하는 이외의 회원과 본원의 권리, 의무 및 책임사항에 관해서는 전기통신사업법 기타 대한민국의 관련 법령과 상관습에 의합니다.
        </p>
        ...
        <p>
        ② 본원은 제1항과 같이 회원으로 가입할 것을 신청한 자가 다음 각 호에 해당하지 않는 한 신청한 자를 회원으로 등록합니다.<br />
        1. 가입신청자가 본 약관 제6조 제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우. 다만 제6조 제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 본원의 회원 재가입 승낙을 얻은 경우에는 예외로 합니다.<br />
        ...
        <p>
        ① 본원은 회원에게 아래와 같은 서비스를 제공합니다.<br />
        1. 본원 뉴스 메일 서비스<br />
        2. 본원 온라인 상담실 / 예약 이용 서비스<br />
        3. 본원 온라인 회원을 위한 섹션 및 컨텐츠 서비스<br />
        ...
        <p>
        ② 제1항에 의한 서비스 중단의 경우에는 본원은 제7조 제2항에서 정한 방법으로 회원에게 통지합니다. <br />
        다만, 본원이 통제할 수 없는 사유로 인한 서비스의 중단(시스템 관리자의 고의, 과실이 없는 디스크 장애, 시스템 다운 등)으로 인하여 사전 통지가 불가능한 경우에는 그러하지 아니합니다.
        </p>
        ...
        <p>
        ② 회원이 다음 각 호의 사유에 해당하는 경우, 본원은 회원의 회원자격을 적절한 방법으로 제한 및 정지, 상실시킬 수 있습니다.<br />
        1. 가입 신청 시에 허위 내용을 등록한 경우<br />
        2. 다른 사람의 본원 사이트 이용을 방해하거나 그 정보를 도용하는 등 전자거래질서를 위협하는 경우<br />
        3. 본원을 이용하여 법령과 본 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우
        </p>
        <p>
        ③ 본원이 회원의 회원자격을 상실시키기로 결정한 경우에는 회원등록을 말소합니다.<br />
        이 경우 회원인 회원에게 회원등록 말소 전에 이를 통지하고, 소명할 기회를 부여합니다.
        </p>
        ...
        <h3>제8조(회원의 개인정보보호)</h3>
        <p>
        본원은 관련법령이 정하는 바에 따라서 회원 등록정보를 포함한 회원의 개인정보를 보호하기 위하여 노력합니다.<br />
        회원의 개인정보보호에 관해서는 관련법령 및 본원이 정하는 "개인정보취급방침"에 정한 바에 의합니다.
        </p>
        ...
        2. 본원에 게시된 정보를 변경하는 행위<br />
        3. 본원 기타 제3자의 인격권 또는 지적재산권을 침해하거나 업무를 방해하는 행위<br />
        ...
        7. 본원의 직원이나 본원 인터넷 서비스의 관리자를 가장하거나 사칭하여 또는 타인의 명의를 도용하여 글을 게시하거나 메일을 발송하는 행위<br />
        8. 컴퓨터 소프트웨어, 하드웨어, 전기통신 장비의 정상적인 가동을 방해, 파괴할 목적으로 고안된 소프트웨어 바이러스, 기타 다른 컴퓨터 코드, 파일, 프로그램을 포함하고 있는 자료를 게시하거나 전자우편으로 발송하는 행위<br />
        9. 스토킹(stalking) 등 다른 회원을 괴롭히는 행위<br />
        10. 다른 회원에 대한 개인정보를 동의 없이 수집, 저장, 공개하는 행위<br />
        11. 불특정 다수의 자를 대상으로 하여 광고 또는 선전을 게시하거나 스팸메일을 전송하는 등의 방법으로 본원의 서비스를 이용하여 영리목적의 활동을 하는 행위<br />
        ...
        <h3>제 12조 (공개게시물의 삭제 및 비공개)</h3>
        <p>
        회원의 공개게시물의 내용이 다음 각 호에 해당하는 경우 본원은 회원에게 사전 통지 없이 해당 공개게시물을 삭제할 수 있고, 해당 회원의 회원 자격을 제한, 정지 또는 상실시킬 수 있습니다.<br />
        ...
        5. 광고성 또는 상업적 목적이 두드러진 경우<br />
        6. 기타 관계 법령에 위배된다고 판단되는 내용
        </p>

        <h3>제13조(저작권의 귀속 및 이용제한)</h3>
        <p>① 본원이 작성한 저작물에 대한 저작권 기타 지적재산권은 본원에 귀속합니다.</p>
        <p>
        ② 회원은 본원을 이용함으로써 얻은 정보를 본원의 사전승낙 없이 복제, 전송, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.
        </p>

        <h3>제14조(상담에 관한 규정)</h3>
        <p>
        ① 서비스에서 진행된 상담의 내용은 개인 신상정보를 삭제한 다음 아래와 같은 목적으로 사용할 수 있습니다.<br />
        1) 학술활동<br />
        2) 진료활동<br />
        3) 의료서비스<br />
        ...
        2) 상식에 어긋나는 표현을 사용하거나 비속어를 사용하여 상담을 신청하는 경우<br />
        ...
        <p>
        부 칙<br />
        ① 이 약관은 2024년 4월 1일을 시작으로 새로운 약관이 나오기 전까지 사용합니다.
        </p>
    </div>
  )
}
